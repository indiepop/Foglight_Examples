Feature: Deploy Cartridge
  ...
  Scenario: Deploy cartridge
    When I execute command 'C:/Quest_Software/Foglight/bin/fglcmd.bat -usr foglight -pwd foglight -cmd agent:deploy -host #agent_host# -allpackages -force' to deploy IC cartridge
