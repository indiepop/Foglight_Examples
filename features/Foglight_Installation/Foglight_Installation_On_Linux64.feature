Feature: Setting up Foglight
  ...
  @yammy @fms
  Scenario: Install Foglight on linux64bit
    Given I have downloaded Foglight installer by the following parameters
      | credential | fogflsw02                                                                                            |
      | from       | /nightly/FoglightServerDist/trunk/*build_number*/linux-x86_64/Foglight-5_6_9_999-linux-x86_64.tar.gz |
      | to         | /home/yammy/Foglight-5_6_9_999-linux-x86_64.tar.gz                                                   |
    When I execute command 'mkdir /home/yammy/Foglight'
    And I execute command 'tar zxvf /home/yammy/Foglight-5_6_9_999-linux-x86_64.tar.gz -C #product_installation_path#'
