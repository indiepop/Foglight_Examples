Feature: Activity -> Overall Datafiles I/O Activity With Alarm
  ...
  Scenario:  Overall Datafiles I/O Activity With Alarm
    ...
    And I click 'Overall Datafiles I/O' link
  ...
  # Click on the arrow for 'Physical Reads' or 'Physical Writes' charts , chart line change accordingly
    And I click 'Physical Reads' link
    And I select 'Physical Reads' in  'Physical Reads'
    And I click 'Physical Writes' link
    And I select 'Physical Writes' in  'Physical Writes'
