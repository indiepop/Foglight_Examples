Feature: automation for Vertical Bars

  @alex @wcf
  Scenario: Test Vertical Bars
    Given opened 'Dashboards -> WCF Regression -> Metric Indicators -> Vertical Bar -> 550 -> Vertical Bars (grid)' screen using default credentials
