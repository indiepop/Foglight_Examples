Feature: automation for Cylinders

  @alex @wcf
  Scenario: Test Cylinders
    Given opened 'Dashboards -> WCF Regression -> Metric Indicators -> Cylinder -> 550 -> Cylinders (grid)' screen using default credentials
